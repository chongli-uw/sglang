...
def grouped_gemm_nt_bf16bf16bf16_masked(
    ...
    _, n, _ = rhs.shape
    kernel_type = compile_utils.DeepGemmKernelType.GROUPED_GEMM_NT_BF16BF16BF16_MASKED
...
def grouped_gemm_nt_bf16bf16bf16_contig(
    ...
    kernel_type = compile_utils.DeepGemmKernelType.GROUPED_GEMM_NT_BF16BF16BF16_CONTIG
